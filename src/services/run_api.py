...
from modules import userRouter, matchRouter, teamRouter, playerRouter, tournamentRouter, emailRouter
...
for router in (userRouter, matchRouter, teamRouter, playerRouter, tournamentRouter, emailRouter):
